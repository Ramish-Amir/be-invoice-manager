...
def register_user(new_user: UserCreate, db: Session = Depends(deps.get_db)):
    email_exists = (
...
def login(
    ...
    if not user_exists or not verify_password(
    ...
    access_token = create_jwt_token(
        data={"username": user_exists.email, "id": user_exists.id},
